...
//   const hiddenColumns = ["SomeHiddenColumn"];

  const hiddenColumns = ["CompID", "ID", "ShortCode", "Deleted"];
...
const handleDelete = async () => {
  ...
  deleteData.append("TableName", "ServiceMast"); // <-- change table name here
    ...
    <>
      <div className="Payment_div">
        <div className="payment_maintext">
          ...
          <div>
            <Link className="payment_breadcrumbs" to={"/servisemaster"}>
              <p>ServiceMast</p>
            </Link>
        ...
        <div className="button_search-payment">
          <Link to={"/servisemaster"}>
            <button type="button" className="btn btn">
              <i className="fa-solid fa-plus"></i> Add ServiceMast
            </button>
          </Link>
...
{!loading && currentRecords.length > 0 && (
  <div className="response-container w-2/4">
