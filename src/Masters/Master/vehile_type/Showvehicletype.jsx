...
const handleDelete = async () => {
  ...
  deleteData.append("TableName", "VehicleTypes"); // <-- change table name here
    ...
    <>
      <div className="Payment_div">
        <div className="payment_maintext">
          ...
          <div>
            <Link className="payment_breadcrumbs" to={"/vehicletype"}>
              <p>VehicleType</p>
            </Link>
        ...
        <div className="button_search-payment">
          <Link to={"/vehicletype"}>
            <button type="button" className="btn btn">
              <i className="fa-solid fa-plus"></i> Add VehicleType
            </button>
          </Link>
        ...
        <div className="records-per-page-container">
          ...
          {!loading && currentRecords.length > 0 && (
             ...
             <div className="response-container w-2/5 ">
